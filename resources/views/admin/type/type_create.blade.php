...
@section('content')
						...
						<form class="am-form tpl-form-line-form" enctype="multipart/form-data" action="{{ url('admin/type') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="am-form-group">
                                     ...
                                     <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">首字母</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" id="user-name" placeholder="A" name="shou">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                ...
                                <script type="text/javascript">
                                    ...
                                    $("button[type='submit']").click(function(){
                                        ...
                                        var show = $("input[name='shou']");
                                        if(brand.val() == '' || photo.val() == '' || show.val() == ''){
