                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <!-- <div class="am-btn-group am-btn-group-xs">
                                                ...
                                                <span class="am-icon-plus"></span><a href="" style="color:#ffffff"> <a></button>
                                            </div> -->
                                        </div>
                                     </div>
                                </div>
                                <div class="widget-body am-fr" style="margin-left:-200px;left:-200px">
                                    <form action="{{url('admin/user_info')}}" method="get" id="myform" class="am-form tpl-form-border-form">
                                        <div class="am-form-group">
                                      ...
                                      <div class="am-form-group">
                                            <label for="user-auth" class="am-u-sm-1 am-form-label am-text-left">权限</label>
                                            <div class="am-u-sm-11">
                                                <input type="text" name="auth" class="tpl-form-input am-margin-top-xs" id="user-auth" placeholder="请输入权限">
                                    ...
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td class="am-text-middle">{{$user->tel}}</td>
                                                <td class="am-text-middle">{{$user->lastLoginTime}}</td>
                                                <td class="am-text-middle">
                                                    <div class="tpl-table-black-operation">
                                                        <a href="{{url('/admin/user_info/'.$user->id.'/edit')}}">
        ...
        <script>
            function dodel($id)
            {
                if(confirm('你确定要删除吗'))
                {
                    ...
                    form.action = '/admin/user_info/'+$id;
                    form.submit();
                }
            }
