...
<div class="navigation">
  <div class="nav-cent">
    ...
    <div class="logo"><a href="#">
      <!-- <img src="{{ asset ('assets/home/images/logo.png') }}" width="240" /> -->
      <img src="{{ asset('upload/'.$config->logo)}}" width="240" height="80"/>
...
<div class="ftWrap">
  ...
  <div class="copyright">
    <div class="cent"> 版权归{{ $config->copyright }}所有 网站归{{ $config->ascription }}所有 </div>
