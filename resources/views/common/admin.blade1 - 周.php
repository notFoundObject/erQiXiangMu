...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/admin/i/favicon.png') }}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('assets/admin/i/app-icon72x72@2x.png')}}">
    <meta name="apple-mobile-web-app-title" content="Amaze UI" />
    <script src="{{asset('assets/admin/js/echarts.min.js')}}"></script>
    <link rel="stylesheet" href="{{asset('assets/admin/css/amazeui.min.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/admin/css/amazeui.datatables.min.css')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('asstes/admin/css/bootstrap.css') }}" />
...
<body data-type="index">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub">
                        ...
                        <li class="sidebar-nav-link">
                            <a href="{{ url('admin/article/add') }}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 文章添加
                            </a>
                        </li>
    ...
    <script src="{{ asset('assets/admin/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets/admin/js/fileupload.min.js') }}"></script>
